<template>
  ...
  <el-dialog v-model="dialogTableVisible" title="个人资料">
    <div class="page">
      <div class="banner">
        <img src="../../assets/userProfileBackground.jpg" alt="Banner" />
      </div>
      <div class="content">
        <div class="profile">
        ...
        <div class="description">
          <el-icon>
            <Phone />
          </el-icon><el-text size="large"> {{ userInfo.phone }} </el-text>
          &nbsp;
          <el-icon>
            <Message />
          </el-icon><el-text size="large"> {{ userInfo.email }} </el-text>
          &nbsp;
          <el-icon>
            <HomeFilled />
          </el-icon><el-text size="large"> {{ userInfo.address }} </el-text>
        </div>
      </div>
    </div>
  </el-dialog>
